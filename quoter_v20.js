...
function clickUpdates() {
   ...
   function idRefProcess() {
    ...
    var setIdTolerance = document.getElementById("id-tolerance");
    return setIdTolerance.innerText = idtolerance;
    }
    idRefProcess();
    var replaceIdRef = document.getElementById("id-tolerance").innerText;
    function odRefProcess(){
    ...
    var setOdTolerance = document.getElementById("od-tolerance");
    return setOdTolerance.innerText = odtolerance;
    }
    odRefProcess();
    var replaceOdRef = document.getElementById("od-tolerance").innerText;
    function wtRefProcess() {
    ...
    var setWtTolerance = document.getElementById("wt-tolerance");
    return setWtTolerance.innerText = wttolerance;
    }
    wtRefProcess();
    var replaceWtRef = document.getElementById("wt-tolerance").innerText;
