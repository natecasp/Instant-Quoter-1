...
function init() {
    ...
    document.getElementById("OD").readOnly = true;
    document.getElementById("wall-thickness").value = 0.0015;
}
...
function clickUpdates() {
    ...
    var next = function() {
        ...
        function getOD(){
          return document.getElementById("OD").value * 1;
        }
        function resetOD(){
